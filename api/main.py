...
def list_ratings(
    skip: int = Query(0, ge=0, description="Nombre de résultats à ignorer"),
    limit: int = Query(100, le=1000, description="Nombre maximal de résultats à retourner"),
    movie_id: Union[int, None] = Query(None, description="Filtrer par ID de film"),
    user_id: Union[int,None] = Query(None, description="Filtrer par ID d'utilisateur"),
    min_rating: Union[float, None] = Query(None, ge=0.0, le=5.0, description="Filtrer les notes supérieures ou égales à cette valeur"),
    db: Session = Depends(get_db)
):
